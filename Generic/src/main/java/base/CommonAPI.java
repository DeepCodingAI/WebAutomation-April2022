...
public class CommonAPI {
    ...
    //cloud env access-keys
    public String browserStackUserName = "your user name";
    public String browserStackAccessKey = "your access key";
    ...
    public void typeOnWebElementNHitEnter(String locator, String value){
        TestLogger.log(getClass().getSimpleName() + ": " + convertToString(new Object(){}.getClass().getEnclosingMethod().getName())+ " to search for: "+ value);
        try {
